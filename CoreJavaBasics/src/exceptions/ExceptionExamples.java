...
public class ExceptionExamples {
	...
	public void readNumber() throws Exception {
		...
		// try to make this so the user has to keep trying
		...
		try {
			...
			// this code executes if no exception occurs
			System.out.println("You entered the number : " + x);
		} catch (ArrayIndexOutOfBoundsException ioe) {
			// can catch a specific type of an exception and deal with it
		...
		System.out.println("This line of code will only execute if no exception is thrown");
